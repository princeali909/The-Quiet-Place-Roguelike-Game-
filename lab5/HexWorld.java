...
import static byog.lab5.RandomWorldDemo.HEIGHT;
import static byog.lab5.RandomWorldDemo.RANDOM;
import static byog.lab5.RandomWorldDemo.WIDTH;
...
public class HexWorld {
    ...
    public static class Position{
        ...
        public Position(int xRowStart, int thisRowY) {
            x = xRowStart;
            y = thisRowY;
    ...
    public static void main(String[] args){
        ...
        addHexagon(world,p,5,Tileset.FLOOR);
